...
This project was done as a part of the Advanced Operating Systems (MCSC202) course at the University of Delhi.\hypertarget{index_autotoc_md1}{}\doxysection{Features}\label{index_autotoc_md1}
...
\hypertarget{index_autotoc_md4}{}\doxysubsection{Creating Files}\label{index_autotoc_md4}
...
\end{DoxyCode}
\hypertarget{index_autotoc_md9}{}\doxysubsection{Writing to Files}\label{index_autotoc_md9}
...
\end{DoxyCode}
\hypertarget{index_autotoc_md11}{}\doxysubsection{Copying Files}\label{index_autotoc_md11}
The {\ttfamily copy} command should be used to copy the contents of one file to another using an unnamed pipe. If the destination file exists, the program will force the user to pass the {\ttfamily -\/f} flag to overwrite it.\hypertarget{index_autotoc_md12}{}\doxysubsubsection{Example\+: Copying a File}\label{index_autotoc_md12}
...
\end{DoxyCode}
\hypertarget{index_autotoc_md15}{}\doxysubsubsection{Example\+: Displaying File Information (\+Special File)}\label{index_autotoc_md15}
...
\end{DoxyCode}
\hypertarget{index_autotoc_md16}{}\doxysubsection{Pipes}\label{index_autotoc_md16}
The {\ttfamily pipe} command should be used to create a pipe and simulate communication between two processes. This program can demonstrate this using both unnamed as well as named pipes.\hypertarget{index_autotoc_md17}{}\doxysubsubsection{Unnamed Pipes}\label{index_autotoc_md17}
...
\end{DoxyCode}
\hypertarget{index_autotoc_md18}{}\doxysubsubsection{Named Pipes}\label{index_autotoc_md18}
If used with the {\ttfamily -\/p} flag, it uses a named pipe in the mode specified by the argument after the path of the pipe. The user is prompted with a message to enter the text to be written to the pipe. The user can enter some text and press {\ttfamily Enter} to send the message. To end the input, the user has to type {\ttfamily \+:q} followed by the {\ttfamily Enter} key.
...
\end{DoxyCode}
\hypertarget{index_autotoc_md19}{}\doxysection{Author}\label{index_autotoc_md19}
Sudipto Ghosh (51)~\newline
